        ...
        <div class="table-responsive">
          <table class="table" id="tblNormal" >
            ...
            <thead>
              ...
              <th colspan="3" style="color:#FFFFFF;font-size:40px; text-align: center">ผู้ป่วยใน
              </tr>
            </thead>
            <tbody>
              <?php foreach ($priority as $pri):?>
                <tr id="blink_<?php echo $pri->hn;?>"
                 style="color:#000000;font-size:42px;background-color:#f8bdff" class="p2">
                  <td>
                    <?php 
                      echo $pri->day_queue_number;
                    // echo $pri->oqueue;
                    ?>
                  </td>
                  <td>
      ...
      <div class="table-responsive">
          <table class="table" id="tblNormal" >
            ...
            <thead>
              ...
              <th colspan="3" style="color:#FFFFFF;font-size:40px; text-align: center">ผู้ป่วยนอก
              </tr>
            </thead>
            <tbody>
              <?php foreach ($pt as $item):?>
                <tr id="blink_<?php echo $item->hn;?>"
                <?php if($item->pt_priority == 2){
                      echo 'style="color:#000000;font-size:42px;background-color:#f00000"';
                      echo ' class="p2"';
                  }else if($item->pt_priority == 1){
                      echo 'style="color:#000000;font-size:42px;background-color:#ff9900"';
                      echo ' class="p1"';
                  }else{
                      echo 'style="color:#000000;font-size:42px;background-color:#00cc00"';
                      echo 'class="n1"';
                  }?>>  
...
<script> 
  ...
  var socket = io.connect( 'http://'+window.location.hostname+':3000' );
    ...
    socket.on("call_phama_ipd_room",function ( data ){
      console.log(data);
