	...
	$('#ForwardSelect').select2();
	$('#ForwardSave').click(function(){
		//console.log( $("#NCDSelect").val() );
		var dep = $("#ForwardSelect").val();
		console.log(dep);
		$.ajax({
			type: "POST",
			url: base_url+"index.php/Config/postForward",
			dataType: 'json',
			data: {dep:dep},
			success: 
				function(data) {
	...
	$('#DrugOPDSelect').select2();
	$('#DrugSubmitOPD').click(function(){
		//console.log( $("#NCDSelect").val() );
		var dep = $("#DrugOPDSelect").val();
		console.log(dep);
		$.ajax({
			type: "POST",
			url: base_url+"index.php/Config/postDrugOPDRoom",
			dataType: 'json',
			data: {dep:dep},
			success: 
				function(data) {
	...
	$('#DrugIPDSelect').select2();
	$('#DrugSubmitIPD').click(function(){
		//console.log( $("#NCDSelect").val() );
		var dep = $("#DrugIPDSelect").val();
		console.log(dep);
		$.ajax({
			type: "POST",
			url: base_url+"index.php/Config/postDrugIPDRoom",
			dataType: 'json',
			data: {dep:dep},
			success: 
				function(data) {
