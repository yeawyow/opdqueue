...
<body class="app ">
  ...
  <header class="app-header">
    ...
    <ul class="app-nav">
      <li class="app-search">
        <h3 style="color:#FFFFFF;">รอพบทันตแพทย์ <?php echo getHospitalName();?></h3>
      </li>
  ...
  var socket = io.connect( 'http://'+window.location.hostname+':3000' );
    ...
    socket.on("Dent",function ( data ){
      ...
      if(data.station==1){
        ...
        $('.ch1').addClass('x1');
        var i = 0;
        var ch1 = setInterval(function(){
          if(i==10){clearInterval(ch1)}
          if ($('.x1').hasClass('c1')){
              $('.x1').removeClass('c1');
        ...
        $('.ch2').addClass('x2');
        var i = 0;
        var ch2 = setInterval(function(){
          if(i==10){clearInterval(ch2)}
          if ($('.x2').hasClass('c2')){
              $('.x2').removeClass('c2');
              console.log('คือบ่ได้',_class);
          }else{
      ...
      var station = 'dent_'+data.station+'.mp3';
      ...
      /** 
      *!document.getElementById('tr_'+queue).style.backgroundColor='#ff00ff'
      *? function blink_text() {
      **  $('#tr_'+queue).fadeOut(500);
      * TODO:  $('#tr_'+queue).fadeIn(500);
      *@param }
      setInterval(blink_text, 1500);
      */
      /*var $div2blink = $('#tr_'+queue);
      var backgroundInterval = setInterval(function(){
        $div2blink.toggle(document.getElementById('tr_'+queue).style.backgroundColor="#F00");
      },1000)*/
