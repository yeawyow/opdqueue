...
<body class="app ">
  ...
  <br />
    ...
    <div class="row">
      <div class="col-8 ">
      <div class="flex  p-3 my-3 text-white bg-primary rounded shadow-sm">
  <div class="row">
...
<div class="row">
 <div class='col-3'>
  <div class=" text-center flex bg-primary rounded shadow-sm " style="font-size:60px;" ><strong>1</strong></div>
</div>
  <div class='col-9'>
  <div class="card  text-white bg-primary mb-3" style="width: 18rem;" >
         <div class="info ch1" id="ch1"><strong></strong></div>
          </div>
            </div>
