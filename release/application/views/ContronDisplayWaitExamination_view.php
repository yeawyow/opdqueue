...
<body class="app ">
  ...
  <header class="app-header">
    ...
    <ul class="app-nav">
      <li class="app-search">
        <h3 style="color:#FFFFFF;">ส่งห้องตรวจ โรงพยาบาลวานรนิวาส</h3>
      </li>
      ...
      <div class="col-md-6">
        ...
        <div class="table-responsive">
          ...
          <table class="table"  id = "tblNomal">
            ...
            <tbody>
              <tr class="table" style="color:#FFFFFF;font-size:25px;background-color:#003399">
                <td> 
                  <?php 
                    if($q->sub_queue=='Y'){
                ...
                <td><?php echo $item->ptname?>&nbsp
                  <?php if($item->lab_count=='1' && $item->report_count=='0'){
      ...
      <div class="col-md-6">
        ...
        <div class="table-responsive">
          ...
          <table class="table" id = "tblUrgent">
            ...
            <tbody>
              <tr class="table " id = "somerow" style="color:#FFFFFF;font-size:25px;background-color:#b34700">
                <td><?php 
                    if($q->sub_queue=='Y'){
