  ...
  <div class="row">
        <div class="col-md-6 col-lg-6">
            <div class="widget-small primary coloured-icon" ><i class="icon" ><strong>5</strong></i>
                <div class="info" id="ch5" style="color:#003300;font-size:50px;"><strong></strong></div>
            </div>
        </div>
        <div class="col-md-6 col-lg-6">
          <div class="widget-small primary coloured-icon"><i class="icon" ><strong>6</strong></i>
              <div class="info" id="ch6" style="color:#003300;font-size:50px;"><strong></strong></div>
          </div>
        </div>
        <div class="col-md-6 col-lg-6">
          <div class="widget-small primary coloured-icon"><i class="icon" ><strong>7</strong></i>
              <div class="info" id="ch7" style="color:#003300;font-size:50px;"><strong></strong></div>
          </div>
        </div>
        <div class="col-md-6 col-lg-6">
          <div class="widget-small primary coloured-icon"><i class="icon" ><strong>8</strong></i>
              <div class="info" id="ch8" style="color:#003300;font-size:50px;"><strong></strong></div>
          </div>
