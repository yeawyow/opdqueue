...
class DisplayWaitPhamacy extends CI_Controller {
    ...
    public function index(){
        ...
        WHERE (v.vstdate='$cur_date' AND r.rx_time>='08:00:00') 
         AND v.vn IN (SELECT vn FROM `wanorn_queue_phama` WHERE `status`='N' AND LEFT(vn,6)='$Y' ) -- AND comname in('DESKTOP-CIO9PVM')
        ...
        $this->load->view('DisplayWaitPhamacy_view',$data);
